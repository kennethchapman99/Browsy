...
export function registerWorkflow({
  ...
  record.versions[version] = {
    ...
    payloadBindings: objectOrEmpty(payloadBindings),
    examplePayload: objectOrEmpty(examplePayload),
    fileUploadBindings: arrayOrEmpty(fileUploadBindings),
    fileBindings: arrayOrEmpty(fileBindings),
    repeatGroups: arrayOrEmpty(repeatGroups),
