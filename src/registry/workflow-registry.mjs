...
export function registerWorkflow({
  ...
  record.versions[version] = {
    ...
    sourceMetadata: objectOrEmpty(sourceMetadata),
    sourceAppId: sourceAppId || null,
    sourceWorkflowId: sourceWorkflowId || null,
    sourcePayloadSchema: objectOrEmpty(sourcePayloadSchema),
    sourceFieldMappings: arrayOrEmpty(sourceFieldMappings),
    tabUrlTemplates: arrayOrEmpty(tabUrlTemplates),
    authProfileRef: authProfileRef || null,
    completionPolicy: objectOrEmpty(completionPolicy),
    writebackTargets: arrayOrEmpty(writebackTargets),
