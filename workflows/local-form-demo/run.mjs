#!/usr/bin/env node
/**
 * Workflow runner: local-form-demo
 * Goal: Generated Browsy workflow.
 *
 ...
 *
 * Usage:
 *   node workflows/local-form-demo/run.mjs [--manifest path] [--dry-run] [--headed] [--no-pause] [--allow-final-action]
 */
...
const WORKFLOW_ID = 'local-form-demo';
